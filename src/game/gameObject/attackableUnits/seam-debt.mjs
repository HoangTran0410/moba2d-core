...
const PINNED_MANA_LINES = new Set([
  'AttackableUnit.ts:517:this.stats.mana.baseValue = constrain(this.stats.mana.baseValue + amount, 0, max);',
...
const PINNED = new Set([
  'AttackableUnit.ts:304:if (!this.isDead && this.game.worldMouse) {',
  'AttackableUnit.ts:309:let mouseDir = p5.Vector.sub(this.game.worldMouse, pos).setMag(size / 2 + 2);',
]);
