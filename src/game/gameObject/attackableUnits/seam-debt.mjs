...
const PINNED_MANA_LINES = new Set([
  'AttackableUnit.ts:555:this.stats.mana.baseValue = constrain(this.stats.mana.baseValue + amount, 0, max);',
  'Champion.ts:667:let mana = this.stats.mana.value;',
]);
...
const PINNED = new Set([
  'AttackableUnit.ts:342:if (!this.isDead && this.game.worldMouse) {',
  'AttackableUnit.ts:347:let mouseDir = p5.Vector.sub(this.game.worldMouse, pos).setMag(size / 2 + 2);',
]);
