...
export { checkStatResourceModifier, type StatResourceModifierOptions } from './statResourceModifier';
export {
...
// seam in this module already does internally. Not exporting it left the
